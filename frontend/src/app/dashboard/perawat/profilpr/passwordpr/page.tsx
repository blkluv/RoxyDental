...
export default function SettingsChangePassword() {
  ...
  const handleSuccessClose = () => {
    ...
    // Redirect ke dashboard utama perawat
      ...
      <Dialog open={successDialogOpen} onOpenChange={setSuccessDialogOpen}>
        <DialogContent className="max-w-md">
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Password Berhasil Diganti!</h3>
            <p className="text-sm text-gray-600 mb-6">
              Password Anda telah berhasil diperbarui. Silakan gunakan password baru untuk login selanjutnya.
            </p>
